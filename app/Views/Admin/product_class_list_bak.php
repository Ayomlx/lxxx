					...
					<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
						...
						<tbody style="text-align: center;">
							<tr role="row" class="odd">
								<td>
									<label class="pos-rel"><input type="checkbox" class="ace" name="info[id]" value="1"><span class="lbl"></span></label>
								</td>
								<td>教育行业</td>
								...
								<td>
									<div class="hidden-sm hidden-xs btn-group">
										<button class="btn btn-xs btn-info">
											<a href="/admin/Product_class/edit?id=1" style="color:#fff;"><i class="ace-icon fa fa-pencil bigger-120"></i></a>
										</button>
										<button class="btn btn-xs btn-danger" onclick="del(1)">
