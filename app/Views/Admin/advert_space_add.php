					...
					<div class="col-xs-12">
						<form class="form-horizontal" id="validation-form" novalidate="novalidate">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="width" id="width" class="col-xs-12 col-sm-3">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="height" id="height" class="col-xs-12 col-sm-3">
									</div>
								</div>
							</div>
		...
		submitHandler: function (form) {
			...
			.done(function(r) {
	            ...
	            if(re.code == 0){
	                ...
	                setTimeout('window.location.href="/Admin/Advert_Space"',1500);
	            }
	        })
		},
	});
