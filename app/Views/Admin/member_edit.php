						...
						<form class="form-horizontal" id="validation-form" novalidate="novalidate">
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="username" id="username" class="col-xs-12 col-sm-3" value="<?= !empty($info['username']) ? $info['username'] : ''; ?>" disabled>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="nickname" id="nickname" class="col-xs-12 col-sm-3" value="<?= !empty($info['nickname']) ? $info['nickname'] : ''; ?>">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<select class="chosen-select form-control" id="form-field-select-3" name="sex" style="display: none;">
										<option value="1" <?= !empty($info['sex']) && $info['sex']==1 ? "selected='selected'" : ''; ?>>男</option>
										<option value="2" <?= !empty($info['sex']) && $info['sex']==2 ? "selected='selected'" : ''; ?>>女</option>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<input class="date-picker col-xs-12 col-sm-3" name="birthday" id="birthday" type="text" data-date-format="yyyy-mm-dd" value="<?= !empty($info['birthday']) ? date('Y-m-d',$info['birthday']) : ''; ?>" autocomplete="off">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="email" id="email" name="email" class="col-xs-12 col-sm-3" value="<?= !empty($info['email']) ? $info['email'] : ''; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="phone" name="phone" class="col-xs-12 col-sm-3" value="<?= !empty($info['phone']) ? $info['phone'] : ''; ?>">
								</div>
							</div>
