					...
					<div class="col-xs-12">
						<form class="form-horizontal" id="validation-form" novalidate="novalidate" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<input class="date-picker col-xs-12 col-sm-3" name="release_time" id="release_time" type="text" data-date-format="yyyy-mm-dd" autocomplete="off" value="<?= !empty($info['release_time']) ? date('Y-m-d',$info['release_time']) : ''; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="hit" id="hit" class="col-xs-12 col-sm-3" autocomplete="off" value="<?= !empty($info['hit']) ? $info['hit'] : ''; ?>">
									</div>
								</div>
							</div>
