					...
					<div class="col-xs-12">
						<form class="form-horizontal" id="validation-form" novalidate="novalidate" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="keyworlds" id="keyworlds" class="col-xs-12 col-sm-3" value="<?= $info['keyworlds']; ?>">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<textarea name="description" cols="41" rows="5"><?= $info['description']; ?></textarea>
									</div>
								</div>
							</div>
								...
								<div class="col-xs-12 col-sm-9">
									<select class="chosen-select form-control" id="form-field-select-3" name="space_id" style="display: none;">
										...
										<?php foreach($space as $key=>$val){ ?>
											<option value="<?= $val['id']; ?>" <?= !empty($info['space_id']) && $info['space_id'] == $val['id'] ? 'selected' : '';?>><?= $val['title']; ?></option>
										<?php }?>
									</select>
								</div>
							</div>
