...
<body class="no-skin">
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="table-header">
						广告管理
						<a href="/Admin/Advert/add"><span class="btn btn-info btn-sm popover-info" style="float: right;margin-top: 2px;margin-right: 20px;"><i class="ace-icon fa fa-plus" data-icon-show="fa-plus" data-icon-hide="fa-minus"></i>添加</span></a>
					</div>
					<div>
	...
	<script type="text/javascript" charset="utf8" src="/public/assets/js/jquery.dataTables.min.js"></script>
	<script src="/public/assets/js/jquery.dataTables.bootstrap.min.js"></script>
	...
	<script type="text/javascript">
		$(function () {
		    var myTable = $('#dynamic-table').DataTable({
		    	...
		    	"aoColumnDefs": [ { "bSortable": false, "aTargets": [ 0 , 1,4, 6] }],
		    	"aaSorting": [[5,"asc"]],
		    	"aoColumns":[
		    		{"data":"field0"},
		    		{"data":"field1"},
