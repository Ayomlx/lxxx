						...
						<form class="form-horizontal" id="validation-form" novalidate="novalidate" enctype="multipart/form-data">
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="title" id="title" class="col-xs-12 col-sm-3" autocomplete="off" value="<?= !empty($info['title']) ? $info['title'] : ''; ?>">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="keywords" id="keywords" class="col-xs-12 col-sm-3" autocomplete="off" value="<?= !empty($info['keywords']) ? $info['keywords'] : ''; ?>">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<textarea class="input-xlarge" name="description" id="description" rows="4" style="width: 310px;"><?= !empty($info['description']) ? $info['description'] : ''; ?></textarea>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<input type="text" name="url" id="sort" class="col-xs-12 col-sm-3" autocomplete="off" value="<?= !empty($info['url']) ? $info['url'] : ''; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="sort" id="sort" class="col-xs-12 col-sm-3" autocomplete="off" value="<?= !empty($info['sort']) ? $info['sort'] : ''; ?>">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<input type="text" name="price" id="price" class="col-xs-12 col-sm-3" autocomplete="off" value="<?= !empty($info['price']) ? $info['price'] : ''; ?>">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<div class="clearfix">
										<textarea class="input-xlarge" name="content" id="content" style="width: 700px;height: 300px;"><?=$info['content'];?></textarea>
									</div>
								</div>
							</div>

							<div class="space-2"></div>
							<input type="hidden" name="imgname" value="<?= $info['pictrue']; ?>">
...
<script type="text/javascript">
	...
	preList[0] = "<img src=\""+reData[0]+"\" class=\"file-preview-image\" width='600'>";
	var previewJson = preList;
	var preConfigList = new Array();
	var tjson = {caption: reData[0], // 展示的文件名
		size:1024,
		width: '100px',
		url: '/index.php/admin/banner/del_pictrue', // 删除url
    ...
    $("#pictrue").fileinput({
    	language: 'zh',
        uploadUrl: '/index.php/Upload/Upload?type=product', // you must set a valid URL here else you will get an error
