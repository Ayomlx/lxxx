					...
					<div class="col-xs-12">
						<form class="form-horizontal" id="validation-form" novalidate="novalidate" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<input class="date-picker col-xs-12 col-sm-3" name="start_time" id="start_time" type="text" data-date-format="yyyy-mm-dd" autocomplete="off">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9">
									<input class="date-picker col-xs-12 col-sm-3" name="end_time" id="end_time" type="text" data-date-format="yyyy-mm-dd" autocomplete="off">
								</div>
							</div>
